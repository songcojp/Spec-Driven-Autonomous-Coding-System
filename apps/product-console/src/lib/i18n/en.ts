...
export const en = {
  ...
  featurePlanning: "Stage 3 Design Planning",
  ...
  uiSpecFlow: "UI Spec",
  uiSpecConceptTitle: "UI Spec Concept",
  uiSpecConceptAlt: "Spec Workspace UI concept image showing the PRD flow",
  uiSpecConceptDescription: "Below is the reference concept image for the Spec Workspace UI flow.",
