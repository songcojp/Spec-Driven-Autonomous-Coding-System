...
- [ ] 当 planning Skill bridge 未实现时，`feature.plan` 必须把 Feature 标记为 blocked，原因固定为 `Planning skill execution bridge is not implemented`，不得生成假任务图或伪造 Skill 输出。
...
WHEN 任务需要代码修改、测试或修复
THE SYSTEM SHALL 通过 Runner CLI Adapter 调用 Codex CLI，并要求输出符合 Evidence schema。
...
| PRD 第 6.9 节 Codex Runner | REQ-037, REQ-038, REQ-039, REQ-065, REQ-066 | Runner 执行、CLI Adapter、JSON 配置与安全策略 |
...
| PRD 第 8 节 页面需求 | REQ-052, REQ-053, REQ-054, REQ-055, REQ-056, REQ-057, REQ-061, REQ-062, REQ-063, REQ-066, REQ-067 | UI 表面需求 |
...
| M4：Codex Runner | REQ-035, REQ-037, REQ-038, REQ-039, REQ-065, REQ-066 |
| M5：状态检测与恢复 | REQ-040, REQ-041, REQ-042, REQ-043, REQ-044, REQ-045 |
| M6：审批与交付 | REQ-046, REQ-047, REQ-048, REQ-049, REQ-050, REQ-057 |
| M7：Product Console | REQ-052, REQ-053, REQ-054, REQ-055, REQ-056, REQ-061, REQ-062, REQ-063, REQ-066, REQ-067 |
