...
| PRD 第 6.9 节 Execution Adapter Layer | REQ-037, REQ-038, REQ-039, REQ-065, REQ-066, REQ-068, REQ-080, REQ-081, REQ-082 | Execution Adapter 执行、CLI Adapter、Codex app-server Adapter、JSON 配置、workspace-aware Skill invocation 与安全策略 |
