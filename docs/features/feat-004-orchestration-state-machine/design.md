...
| Feature Pool Queue Reader | 读取 `docs/features/feature-pool-queue.json`，按 priority、dependencies、`spec-state.json` status 找到下一个可执行 Feature。 |
