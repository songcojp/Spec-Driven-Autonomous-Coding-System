...
| Spec Workspace View | 展示阶段 1 项目初始化、阶段 2 需求录入、Feature Spec、澄清、Checklist、计划、数据模型、契约、任务图和版本 diff。 |
...
5. Spec Workspace 从项目、仓库连接、项目宪章、Project Memory、Feature、Requirement 和审计事件派生 PRD 流程阶段状态；阶段 1 展示项目初始化事实，阶段 2 只展示 PRD 扫描、上传、格式识别、EARS / Feature Spec 生成、澄清、质量检查和 Feature Spec Pool 状态。
